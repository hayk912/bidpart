...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.filesize'
        db.add_column('files_image', 'filesize',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Image.width'
        db.add_column('files_image', 'width',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Image.height'
        db.add_column('files_image', 'height',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'File.filesize'
        db.add_column('files_file', 'filesize',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.filesize'
        db.delete_column('files_image', 'filesize')

        # Deleting field 'Image.width'
        db.delete_column('files_image', 'width')

        # Deleting field 'Image.height'
        db.delete_column('files_image', 'height')

        # Deleting field 'File.filesize'
        db.delete_column('files_file', 'filesize')
