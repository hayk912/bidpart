...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('files_file', (
            ...
            ('title_slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), null=True, populate_from='title')),
            ('description_short', self.gf('django.db.models.fields.TextField')()),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('unique_hash', self.gf('django.db.models.fields.CharField')(max_length=32, unique=True, null=True, blank=True)),
