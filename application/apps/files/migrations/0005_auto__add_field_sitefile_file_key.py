...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteFile.file_key'
        db.add_column('files_sitefile', 'file_key',
                      self.gf('django.db.models.fields.CharField')(default='asdf', unique=True, max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteFile.file_key'
        db.delete_column('files_sitefile', 'file_key')
    ...
    models = {
        ...
        'files.sitefile': {
            'Meta': {'object_name': 'SiteFile', '_ormbases': ['files.File']},
            'file_key': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '64'}),
