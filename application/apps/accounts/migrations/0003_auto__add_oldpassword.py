...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OldPassword'
        db.create_table('accounts_oldpassword', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('old_password', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('old_nonce', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal('accounts', ['OldPassword'])


    def backwards(self, orm):
        # Deleting model 'OldPassword'
        db.delete_table('accounts_oldpassword')
