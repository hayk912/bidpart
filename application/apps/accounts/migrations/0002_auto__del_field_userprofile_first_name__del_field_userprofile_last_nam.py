...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BusinessProfile.business_description'
        db.add_column('accounts_businessprofile', 'business_description',
    ...
    def backwards(self, orm):
        ...
        db.add_column('accounts_userprofile', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.last_name'
        db.add_column('accounts_userprofile', 'last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Deleting field 'BusinessProfile.business_description'
        db.delete_column('accounts_businessprofile', 'business_description')
