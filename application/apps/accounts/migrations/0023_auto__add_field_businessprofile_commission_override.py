...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessProfile.commission_override'
        db.add_column('accounts_businessprofile', 'commission_override',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=2, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessProfile.commission_override'
        db.delete_column('accounts_businessprofile', 'commission_override')
    ...
    models = {
        ...
        'accounts.businessprofile': {
            ...
            'commission_override': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '2', 'decimal_places': '2'}),
