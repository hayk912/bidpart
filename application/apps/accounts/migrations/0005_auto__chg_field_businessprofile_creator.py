...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BusinessProfile.creator'
        db.alter_column('accounts_businessprofile', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.UserProfile']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BusinessProfile.creator'
        raise RuntimeError("Cannot reverse this migration. 'BusinessProfile.creator' and its values cannot be restored.")
