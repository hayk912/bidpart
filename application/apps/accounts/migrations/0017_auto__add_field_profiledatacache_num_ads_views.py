...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProfileDataCache.num_ads_views'
        db.add_column('accounts_profiledatacache', 'num_ads_views',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProfileDataCache.num_ads_views'
        db.delete_column('accounts_profiledatacache', 'num_ads_views')
