...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_businessprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['accounts.UserProfile'])),
            ('business_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True)),
        ))
        db.send_create_signal('accounts', ['BusinessProfile'])
        ...
        db.create_table('accounts_userprofile', (
            ...
            ('active_profile', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['accounts.BusinessProfile'])),
        ...
        # Adding M2M table for field business_profiles on 'UserProfile'
        db.create_table('accounts_userprofile_business_profiles', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['accounts.userprofile'], null=False)),
            ('businessprofile', models.ForeignKey(orm['accounts.businessprofile'], null=False))
        ))
        db.create_unique('accounts_userprofile_business_profiles', ['userprofile_id', 'businessprofile_id'])


    def backwards(self, orm):
        # Deleting model 'BusinessProfile'
        db.delete_table('accounts_businessprofile')

        # Deleting model 'UserProfile'
        db.delete_table('accounts_userprofile')

        # Removing M2M table for field business_profiles on 'UserProfile'
        db.delete_table('accounts_userprofile_business_profiles')
