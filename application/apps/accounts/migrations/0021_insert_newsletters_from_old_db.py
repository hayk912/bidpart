...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        emails = [
            'lelle@bidpart.se',
            'lars@almeroil.se',
            'sorenbroman@gmail.com',
            'kenneth.larsson@dbschenker.com',
            'peter@nrdab.se',
            'orjan.sverker@gmail.com',
            'erlend.rydsa@norskeskog.com',
            'info@uhfg.se',
            'info@idealforyou.se',
            'nygaard.engineering@gmail.com',
            'marcus.gustafsson@reconsil.se',
            'greger.jonsson@mevagroup.se',
            'je@jekroon.se',
            'mattias.r@kopparbergs.se',
            'henrik@duab.com',
            'robert.mattsson@vattenfall.se',
            'christian.holmesland@pals.no',
        ]
        queryset = orm['accounts.UserProfile'].objects.filter(user__email__in=emails)
