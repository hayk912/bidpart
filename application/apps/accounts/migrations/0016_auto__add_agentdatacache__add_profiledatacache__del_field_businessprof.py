...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AgentDataCache'
        db.create_table('accounts_agentdatacache', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('num_recruited', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('num_sold_products', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('num_interested', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('num_active', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('num_completed', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('num_canceled', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('accounts', ['AgentDataCache'])

        # Adding model 'ProfileDataCache'
        db.create_table('accounts_profiledatacache', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('current_commission_perc', self.gf('django.db.models.fields.DecimalField')(default='0.1', max_digits=3, decimal_places=2)),
            ('num_sold_products', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('num_ads', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('accounts', ['ProfileDataCache'])

        # Deleting field 'BusinessProfile.num_recruited'
        db.delete_column('accounts_businessprofile', 'num_recruited')

        # Deleting field 'BusinessProfile.current_commission_perc'
        db.delete_column('accounts_businessprofile', 'current_commission_perc')

        # Deleting field 'BusinessProfile.num_ads'
        db.delete_column('accounts_businessprofile', 'num_ads')

        # Deleting field 'BusinessProfile.num_sold_products'
        db.delete_column('accounts_businessprofile', 'num_sold_products')

        # Adding field 'BusinessProfile.profile_data_cache'
        db.add_column('accounts_businessprofile', 'profile_data_cache',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.ProfileDataCache'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BusinessProfile.agent_data_cache'
        db.add_column('accounts_businessprofile', 'agent_data_cache',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.AgentDataCache'], unique=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'BusinessProfile.agent'
        db.alter_column('accounts_businessprofile', 'agent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.BusinessProfile'], null=True))

    def backwards(self, orm):
        # Deleting model 'AgentDataCache'
        db.delete_table('accounts_agentdatacache')

        # Deleting model 'ProfileDataCache'
        db.delete_table('accounts_profiledatacache')

        # Adding field 'BusinessProfile.num_recruited'
        db.add_column('accounts_businessprofile', 'num_recruited',
        ...
        # Adding field 'BusinessProfile.num_ads'
        db.add_column('accounts_businessprofile', 'num_ads',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
        ...
        # Deleting field 'BusinessProfile.profile_data_cache'
        db.delete_column('accounts_businessprofile', 'profile_data_cache_id')

        # Deleting field 'BusinessProfile.agent_data_cache'
        db.delete_column('accounts_businessprofile', 'agent_data_cache_id')


        # Changing field 'BusinessProfile.agent'
        db.alter_column('accounts_businessprofile', 'agent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.UserProfile']))
