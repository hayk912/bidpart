...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessProfile.is_agent'
        db.add_column('accounts_businessprofile', 'is_agent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessProfile.is_agent'
        db.delete_column('accounts_businessprofile', 'is_agent')
