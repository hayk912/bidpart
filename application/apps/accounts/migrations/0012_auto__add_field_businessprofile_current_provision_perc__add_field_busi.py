...
class Migration(SchemaMigration):
    ...
    models = {
        'accounts.businessprofile': {
            ...
            'current_provision_perc': ('django.db.models.fields.DecimalField', [], {'default': "'0.1'", 'max_digits': '3', 'decimal_places': '2'}),
            ...
            'num_sold_ads': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
