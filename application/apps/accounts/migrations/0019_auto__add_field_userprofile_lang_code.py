...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.lang_code'
        db.add_column('accounts_userprofile', 'lang_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.lang_code'
        db.delete_column('accounts_userprofile', 'lang_code')
