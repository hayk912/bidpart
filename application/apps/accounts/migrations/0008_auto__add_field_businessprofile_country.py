...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessProfile.country'
        db.add_column('accounts_businessprofile', 'country',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessProfile.country'
        db.delete_column('accounts_businessprofile', 'country')
