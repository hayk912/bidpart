...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BusinessProfile.num_reqruited'
        db.delete_column('accounts_businessprofile', 'num_reqruited')
    ...
    def backwards(self, orm):
        # Adding field 'BusinessProfile.num_reqruited'
        db.add_column('accounts_businessprofile', 'num_reqruited',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
