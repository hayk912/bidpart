...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_userprofile', 'avatar',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['files.Image'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'BusinessProfile.image'
        db.delete_column('accounts_businessprofile', 'image')

        # Adding field 'BusinessProfile.logo'
        db.add_column('accounts_businessprofile', 'logo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['files.Image'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('accounts_userprofile', 'avatar_id')
        ...
        # Deleting field 'BusinessProfile.logo'
        db.delete_column('accounts_businessprofile', 'logo_id')
