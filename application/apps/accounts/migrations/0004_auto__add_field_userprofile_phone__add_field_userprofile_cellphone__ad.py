...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_userprofile', 'cellphone',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=32),
                      keep_default=False)

        # Adding field 'BusinessProfile.agent'
        db.add_column('accounts_businessprofile', 'agent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='agent', null=True, to=orm['accounts.UserProfile']),
                      keep_default=False)

        # Adding field 'BusinessProfile.image'
        db.add_column('accounts_businessprofile', 'image',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BusinessProfile.address'
        db.add_column('accounts_businessprofile', 'address',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=64),
                      keep_default=False)

        # Adding field 'BusinessProfile.address_zipcode'
        db.add_column('accounts_businessprofile', 'address_zipcode',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=5),
                      keep_default=False)

        # Adding field 'BusinessProfile.address_city'
        db.add_column('accounts_businessprofile', 'address_city',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=64),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BusinessProfile.agent'
        db.delete_column('accounts_businessprofile', 'agent_id')

        # Deleting field 'BusinessProfile.image'
        db.delete_column('accounts_businessprofile', 'image')

        # Deleting field 'BusinessProfile.address'
        db.delete_column('accounts_businessprofile', 'address')

        # Deleting field 'BusinessProfile.address_zipcode'
        db.delete_column('accounts_businessprofile', 'address_zipcode')

        # Deleting field 'BusinessProfile.address_city'
        db.delete_column('accounts_businessprofile', 'address_city')
