...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Field.help_text'
        db.delete_column('ads_field', 'help_text')

        # Deleting field 'Field.label'
        db.delete_column('ads_field', 'label')


    def backwards(self, orm):
        # Adding field 'Field.help_text'
        db.add_column('ads_field', 'help_text',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Field.label'
        db.add_column('ads_field', 'label',
