...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ad.featured'
        db.add_column('ads_ad', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Ad.num_views'
        db.add_column('ads_ad', 'num_views',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ad.featured'
        db.delete_column('ads_ad', 'featured')

        # Deleting field 'Ad.num_views'
        db.delete_column('ads_ad', 'num_views')
