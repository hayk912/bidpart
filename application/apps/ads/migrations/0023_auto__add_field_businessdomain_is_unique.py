...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessDomain.is_unique'
        db.add_column('ads_businessdomain', 'is_unique',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessDomain.is_unique'
        db.delete_column('ads_businessdomain', 'is_unique')
