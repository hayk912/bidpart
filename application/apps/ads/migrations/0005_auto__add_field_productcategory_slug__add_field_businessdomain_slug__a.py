...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ads_productcategory', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique=True, null='True', populate_from='title', unique_with=()),
                      keep_default=False)

        # Adding field 'BusinessDomain.slug'
        db.add_column('ads_businessdomain', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique=True, null='True', populate_from='title', unique_with=()),
                      keep_default=False)

        # Adding field 'ProductType.slug'
        db.add_column('ads_producttype', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique=True, null='True', populate_from='title', unique_with=()),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('ads_productcategory', 'slug')

        # Deleting field 'BusinessDomain.slug'
        db.delete_column('ads_businessdomain', 'slug')

        # Deleting field 'ProductType.slug'
        db.delete_column('ads_producttype', 'slug')
