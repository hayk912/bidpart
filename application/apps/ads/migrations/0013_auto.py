...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field images on 'Ad'
        db.create_table('ads_ad_images', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ad', models.ForeignKey(orm['ads.ad'], null=False)),
            ('image', models.ForeignKey(orm['files.image'], null=False))
        ))
        db.create_unique('ads_ad_images', ['ad_id', 'image_id'])

        # Adding M2M table for field files on 'Ad'
        db.create_table('ads_ad_files', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ad', models.ForeignKey(orm['ads.ad'], null=False)),
            ('file', models.ForeignKey(orm['files.file'], null=False))
        ))
        db.create_unique('ads_ad_files', ['ad_id', 'file_id'])


    def backwards(self, orm):
        # Removing M2M table for field images on 'Ad'
        db.delete_table('ads_ad_images')

        # Removing M2M table for field files on 'Ad'
        db.delete_table('ads_ad_files')
