...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ad.currency'
        db.add_column('ads_ad', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', to=orm['currencies.Currency']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ad.currency'
        db.delete_column('ads_ad', 'currency_id')
