...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('ads', ['AdImage'])

        # Adding model 'AdFile'
        db.create_table('ads_adfile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['files.File'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ads.Ad'])),
        ))
        db.send_create_signal('ads', ['AdFile'])

    def backwards(self, orm):
        # Deleting model 'AdImage'
        db.delete_table('ads_adimage')

        # Deleting model 'AdFile'
        db.delete_table('ads_adfile')
