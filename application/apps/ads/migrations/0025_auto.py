...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Ad', fields ['title']
        db.create_index('ads_ad', ['title'])

        # Adding index on 'Ad', fields ['is_request']
        db.create_index('ads_ad', ['is_request'])

        # Adding index on 'Ad', fields ['featured']
        db.create_index('ads_ad', ['featured'])

        # Adding index on 'Ad', fields ['published']
        db.create_index('ads_ad', ['published'])

        # Adding index on 'Ad', fields ['active']
        db.create_index('ads_ad', ['active'])


    def backwards(self, orm):
        # Removing index on 'Ad', fields ['active']
        db.delete_index('ads_ad', ['active'])

        # Removing index on 'Ad', fields ['published']
        db.delete_index('ads_ad', ['published'])

        # Removing index on 'Ad', fields ['featured']
        db.delete_index('ads_ad', ['featured'])

        # Removing index on 'Ad', fields ['is_request']
        db.delete_index('ads_ad', ['is_request'])

        # Removing index on 'Ad', fields ['title']
        db.delete_index('ads_ad', ['title'])
