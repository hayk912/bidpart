...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ad.description_en'
        db.add_column('ads_ad', 'description_en',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # rename description to description_sv
        db.rename_column('ads_ad', 'description', 'description_sv')


        # Adding field 'Ad.title_en'
        db.add_column('ads_ad', 'title_en',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=64, blank=True),
                      keep_default=False)

        # rename title to title_sv
        db.rename_column('ads_ad', 'title', 'title_sv')


    def backwards(self, orm):
        # Deleting field 'Ad.description_en'
        db.delete_column('ads_ad', 'description_en')

        # Deleting field 'Ad.description_sv'
        db.rename_column('ads_ad', 'description_sv', 'description')

        # Deleting field 'Ad.title_en'
        db.delete_column('ads_ad', 'title_en')

        # Deleting field 'Ad.title_sv'
        db.rename_column('ads_ad', 'title_sv', 'title')
    ...
    models = {
        ...
        'ads.ad': {
            ...
            'description_sv': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'last_deal_updated': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'title_en': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '64', 'blank': 'True'}),
            'title_sv': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '64', 'blank': 'True'}),
        ...
        'ads.businessdomain': {
            'Meta': {'ordering': "['title']", 'object_name': 'BusinessDomain'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
