...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ads_fieldchoice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal('ads', ['FieldChoice'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('ads_fieldchoice')
    ...
    models = {
        ...
        'ads.field': {
            ...
            'choices': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'field'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['ads.FieldChoice']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
