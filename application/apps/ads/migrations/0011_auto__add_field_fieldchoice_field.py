...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field choices on 'Field'
        db.delete_table('ads_field_choices')

        # Adding field 'FieldChoice.field'
        db.add_column('ads_fieldchoice', 'field',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='field_choice', to=orm['ads.Field']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding M2M table for field choices on 'Field'
        db.create_table('ads_field_choices', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('field', models.ForeignKey(orm['ads.field'], null=False)),
            ('fieldchoice', models.ForeignKey(orm['ads.fieldchoice'], null=False))
        ))
        db.create_unique('ads_field_choices', ['field_id', 'fieldchoice_id'])

        # Deleting field 'FieldChoice.field'
        db.delete_column('ads_fieldchoice', 'field_id')
