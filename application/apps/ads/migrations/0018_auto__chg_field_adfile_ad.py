...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AdImage.ad'
        db.alter_column('ads_adimage', 'ad_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ads.Ad']))

        # Changing field 'AdFile.ad'
        db.alter_column('ads_adfile', 'ad_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ads.Ad'], null=True))

    def backwards(self, orm):

        # Changing field 'AdImage.ad'
        db.alter_column('ads_adimage', 'ad_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ads.Ad']))

        # Changing field 'AdFile.ad'
        db.alter_column('ads_adfile', 'ad_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ads.Ad']))
