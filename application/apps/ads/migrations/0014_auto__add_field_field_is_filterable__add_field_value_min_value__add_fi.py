...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Field.is_filterable'
        db.add_column('ads_field', 'is_filterable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Value.min_value'
        db.add_column('ads_value', 'min_value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'Value.max_value'
        db.add_column('ads_value', 'max_value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Field.is_filterable'
        db.delete_column('ads_field', 'is_filterable')

        # Deleting field 'Value.min_value'
        db.delete_column('ads_value', 'min_value')

        # Deleting field 'Value.max_value'
        db.delete_column('ads_value', 'max_value')
