...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InvoiceLogEntry'
        db.create_table('invoice_invoicelogentry', (
        ...
        db.send_create_signal('invoice', ['InvoiceLogEntry'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'InvoiceLogEntry'
        db.delete_table('invoice_invoicelogentry')
