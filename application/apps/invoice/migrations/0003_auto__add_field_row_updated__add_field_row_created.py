...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('invoice_row', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 10, 24, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Row.created'
        db.add_column('invoice_row', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 10, 24, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Row.updated'
        db.delete_column('invoice_row', 'updated')

        # Deleting field 'Row.created'
        db.delete_column('invoice_row', 'created')
