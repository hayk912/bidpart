...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.terms_net_days'
        db.add_column('invoice_invoice', 'terms_net_days',
                      self.gf('django.db.models.fields.IntegerField')(default=10, max_length=2),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Invoice.terms_net_days'
        db.delete_column('invoice_invoice', 'terms_net_days')
