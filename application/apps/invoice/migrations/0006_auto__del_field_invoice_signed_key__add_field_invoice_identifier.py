...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Invoice.signed_key'
        db.delete_column('invoice_invoice', 'signed_key')

        # Adding field 'Invoice.identifier'
        db.add_column('invoice_invoice', 'identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Invoice.signed_key'
        db.add_column('invoice_invoice', 'signed_key',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Invoice.identifier'
        db.delete_column('invoice_invoice', 'identifier')
    ...
    models = {
        ...
        'invoice.invoice': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
