...
class Migration(SchemaMigration):
    ...
    #def forwards(self, orm):
        # Removing unique constraint on 'Row', fields ['identifier']
        #db.delete_unique('invoice_row', ['identifier'])


    def backwards(self, orm):
        # Adding unique constraint on 'Row', fields ['identifier']
        db.create_unique('invoice_row', ['identifier'])
