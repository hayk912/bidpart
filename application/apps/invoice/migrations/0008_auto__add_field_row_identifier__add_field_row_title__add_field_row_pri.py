...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Row.identifier'
        #db.add_column('invoice_row', 'identifier',
         #             self.gf('django.db.models.fields.CharField')(default='0-0', unique=True, max_length=16),
          #            keep_default=False)

        # Adding field 'Row.identifier'
     # db.create_index('invoice_row', ['identifier'], unique=True)

        # Adding field 'Row.title'
        db.add_column('invoice_row', 'title',
                      self.gf('django.db.models.fields.CharField')(default='title', max_length=64),
                      keep_default=False)

        # Adding field 'Row.price'
        db.add_column('invoice_row', 'price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)

        # Adding field 'Row.currency'
        db.add_column('invoice_row', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['currencies.Currency']),
                      keep_default=False)


        # Changing field 'Row.deal'
        db.alter_column('invoice_row', 'deal_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['deals.Deal'], null=True))
        # Adding field 'Invoice.title'
        db.add_column('invoice_invoice', 'title',
                      self.gf('django.db.models.fields.CharField')(default=u'Invoice', max_length=64),
                      keep_default=False)


        # Changing field 'Invoice.our_reference'
        db.alter_column('invoice_invoice', 'our_reference_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
        # Adding index on 'Invoice', fields ['state']
        db.create_index('invoice_invoice', ['state'])


        # Changing field 'Invoice.your_reference'
        db.alter_column('invoice_invoice', 'your_reference_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        'invoice.invoice': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "u'Invoice'", 'max_length': '64'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
