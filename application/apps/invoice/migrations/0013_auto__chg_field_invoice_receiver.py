...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invoice.receiver'
        db.alter_column('invoice_invoice', 'receiver_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.BusinessProfile'], null=True))

    def backwards(self, orm):

        # Changing field 'Invoice.receiver'
        db.alter_column('invoice_invoice', 'receiver_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.BusinessProfile']))
    ...
    models = {
        ...
        'invoice.invoice': {
            ...
            'is_written_to_disk': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'receiver': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.BusinessProfile']", 'null': 'True', 'blank': 'True'}),
