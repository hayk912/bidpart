...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('invoice_invoice', (
            ...
            ('receiver', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.BusinessProfile'])),
            ('our_reference', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='our_reference', null=True, to=orm['accounts.UserProfile'])),
            ('your_reference', self.gf('django.db.models.fields.related.ForeignKey')(related_name='your_reference', to=orm['accounts.UserProfile'])),
            ('sent', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('sent_timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('state', self.gf('django.db.models.fields.CharField')(default='created', max_length=16)),
        ...
        db.send_create_signal('invoice', ['Row'])

        # Adding model 'InvoiceLog'
        db.create_table('invoice_invoicelog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('invoice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invoice.Invoice'])),
            ('action', self.gf('django.db.models.fields.CharField')(default='created', max_length=16)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('invoice', ['InvoiceLog'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Row'
        db.delete_table('invoice_row')

        # Deleting model 'InvoiceLog'
        db.delete_table('invoice_invoicelog')
    ...
    models = {
        ...
        'invoice.invoice': {
            ...
            'sent_timestamp': ('django.db.models.fields.DateTimeField', [], {}),
