...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.is_written_to_disk'
        db.add_column('invoice_invoice', 'is_written_to_disk',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.is_written_to_disk'
        db.delete_column('invoice_invoice', 'is_written_to_disk')
