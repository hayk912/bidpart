...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cms_emailtemplate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('txt_en', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('txt_sv', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('html_en', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('html_sv', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('subject_en', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('subject_sv', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32)),
        ))
        db.send_create_signal('cms', ['EmailTemplate'])


    def backwards(self, orm):
        # Deleting model 'EmailTemplate'
        db.delete_table('cms_emailtemplate')
