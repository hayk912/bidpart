...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deal.last_reminder'
        db.alter_column('deals_deal', 'last_reminder', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 10, 30, 0, 0)))

    def backwards(self, orm):

        # Changing field 'Deal.last_reminder'
        db.alter_column('deals_deal', 'last_reminder', self.gf('django.db.models.fields.DateTimeField')(null=True))
