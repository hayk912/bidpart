...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deal.agent_currency'
        db.alter_column('deals_deal', 'agent_currency_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['currencies.Currency']))

    def backwards(self, orm):

        # Changing field 'Deal.agent_currency'
        db.alter_column('deals_deal', 'agent_currency_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['currencies.Currency']))
    ...
    models = {
        ...
        'deals.deal': {
            ...
            'agent_currency': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'agent_currency'", 'null': 'True', 'to': "orm['currencies.Currency']"}),
