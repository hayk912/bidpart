...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.test'
        db.add_column('deals_deal', 'test',
                      self.gf('django.db.models.fields.CharField')(default='Lars', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.test'
        db.delete_column('deals_deal', 'test')
    ...
    models = {
        ...
        'deals.deal': {
            ...
            'test': ('django.db.models.fields.CharField', [], {'default': "'Lars'", 'max_length': '30', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        }
    }
