...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.bid'
        db.add_column('deals_deal', 'bid',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Deal.price'
        db.add_column('deals_deal', 'price',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=20, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.bid'
        db.delete_column('deals_deal', 'bid')

        # Deleting field 'Deal.price'
        db.delete_column('deals_deal', 'price')
