...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.currency'
        db.add_column('deals_deal', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='currency', to=orm['currencies.Currency']),
                      keep_default=False)

        # Adding field 'Deal.commission'
        db.add_column('deals_deal', 'commission',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Deal.commission_currency'
        db.add_column('deals_deal', 'commission_currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='comission_currency', to=orm['currencies.Currency']),
                      keep_default=False)

        # Adding field 'Deal.agent_commission'
        db.add_column('deals_deal', 'agent_commission',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Deal.agent_currency'
        db.add_column('deals_deal', 'agent_currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='agent_currency', to=orm['currencies.Currency']),
                      keep_default=False)

        # Adding field 'Deal.last_reminder'
        db.add_column('deals_deal', 'last_reminder',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deal.manual_processing'
        db.add_column('deals_deal', 'manual_processing',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Deal.payed_to_agent'
        db.add_column('deals_deal', 'payed_to_agent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Deal.cancel_reason'
        db.add_column('deals_deal', 'cancel_reason',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.currency'
        db.delete_column('deals_deal', 'currency_id')

        # Deleting field 'Deal.commission'
        db.delete_column('deals_deal', 'commission')

        # Deleting field 'Deal.commission_currency'
        db.delete_column('deals_deal', 'commission_currency_id')

        # Deleting field 'Deal.agent_commission'
        db.delete_column('deals_deal', 'agent_commission')

        # Deleting field 'Deal.agent_currency'
        db.delete_column('deals_deal', 'agent_currency_id')

        # Deleting field 'Deal.last_reminder'
        db.delete_column('deals_deal', 'last_reminder')

        # Deleting field 'Deal.manual_processing'
        db.delete_column('deals_deal', 'manual_processing')

        # Deleting field 'Deal.payed_to_agent'
        db.delete_column('deals_deal', 'payed_to_agent')

        # Deleting field 'Deal.cancel_reason'
        db.delete_column('deals_deal', 'cancel_reason')
    ...
    models = {
        ...
        'ads.ad': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'files': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'ad_files'", 'blank': 'True', 'to': "orm['files.File']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'images': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'ad_images'", 'blank': 'True', 'to': "orm['files.Image']"}),
