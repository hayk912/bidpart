...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.invoice'
        db.add_column('deals_deal', 'invoice',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invoice.Invoice'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.invoice'
        db.delete_column('deals_deal', 'invoice_id')
