...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deal.bid'
        db.alter_column('deals_deal', 'bid', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2))

        # Changing field 'Deal.amount'
        db.alter_column('deals_deal', 'amount', self.gf('django.db.models.fields.IntegerField')(default=0))
        # Adding unique constraint on 'Deal', fields ['owner', 'ad']
        db.create_unique('deals_deal', ['owner_id', 'ad_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Deal', fields ['owner', 'ad']
        db.delete_unique('deals_deal', ['owner_id', 'ad_id'])

        # Adding field 'Deal.agent_currency'
        db.add_column('deals_deal', 'agent_currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='agent_currency', null=True, to=orm['currencies.Currency'], blank=True),
                      keep_default=False)


        # Changing field 'Deal.bid'
        db.alter_column('deals_deal', 'bid', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

        # Changing field 'Deal.amount'
        db.alter_column('deals_deal', 'amount', self.gf('django.db.models.fields.IntegerField')(null=True))
