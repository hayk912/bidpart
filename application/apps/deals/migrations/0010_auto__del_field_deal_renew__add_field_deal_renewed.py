...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Deal.renew'
        db.delete_column('deals_deal', 'renew')

        # Adding field 'Deal.renewed'
        db.add_column('deals_deal', 'renewed',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Deal.renew'
        raise RuntimeError("Cannot reverse this migration. 'Deal.renew' and its values cannot be restored.")
        # Deleting field 'Deal.renewed'
        db.delete_column('deals_deal', 'renewed')
