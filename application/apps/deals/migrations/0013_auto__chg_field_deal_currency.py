...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deal.currency'
        db.alter_column('deals_deal', 'currency_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['currencies.Currency']))

    def backwards(self, orm):

        # Changing field 'Deal.currency'
        db.alter_column('deals_deal', 'currency_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['currencies.Currency']))
