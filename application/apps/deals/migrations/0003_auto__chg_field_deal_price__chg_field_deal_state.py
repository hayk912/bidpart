...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deal.price'
        db.alter_column('deals_deal', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

        # Changing field 'Deal.state'
        db.alter_column('deals_deal', 'state', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

    def backwards(self, orm):

        # Changing field 'Deal.price'
        db.alter_column('deals_deal', 'price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2))

        # Changing field 'Deal.state'
        db.alter_column('deals_deal', 'state', self.gf('django.db.models.fields.CharField')(default='interested', max_length=32))
    ...
    models = {
        ...
        'deals.deal': {
            ...
            'state': ('django.db.models.fields.CharField', [], {'default': "'interested'", 'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        }
    }
