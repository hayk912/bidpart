...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('deals_deal', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.UserProfile'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.BusinessProfile'])),
